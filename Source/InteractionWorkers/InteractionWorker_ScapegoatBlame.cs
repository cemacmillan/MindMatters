...
namespace MindMatters
{
    public class InteractionWorker_ScapegoatBlame : InteractionWorker
    {
        ...
        public override float RandomSelectionWeight(Pawn initiator, Pawn recipient)
        {
            ...
            if (initiator.needs.mood.CurLevelPercentage > 0.5f ||
            ...
            // Check if the recipient is the scapegoat and their mood is higher than the initiator's
            if (!victimManager.IsScapegoat(recipient) ||
                recipient.needs.mood.CurLevelPercentage <= initiator.needs.mood.CurLevelPercentage ||
        ...
        public override void Interacted(Pawn initiator, Pawn recipient, List<RulePackDef> extraSentencePacks, out string letterText, out string letterLabel, out LetterDef letterDef, out LookTargets lookTargets)
        {
            ...
            initiator.needs.mood.thoughts.memories.TryGainMemory(ThoughtDefOfMindMatters.MindMatters_CalledSomeoneOut);

            // Apply a mood debuff to the scapegoat
            recipient.needs.mood.thoughts.memories.TryGainMemory(ThoughtDefOfMindMatters.MindMatters_WasBlamed);
