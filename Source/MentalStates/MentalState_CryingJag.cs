...
namespace MindMatters
{
    ...
    public class MentalState_CryingJag : MentalState_BabyFit
    {
        ...
        protected override void AuraEffect(Thing source, Pawn hearer)
        {
            ...
            if (hearer.story != null && (hearer.story.traits.HasTrait(TraitDefOf.Psychopath) || hearer.story.traits.HasTrait(DefDatabase<TraitDef>.GetNamed("Desensitized"))) || hearer.needs?.mood == null)
            {
                return;
            }
